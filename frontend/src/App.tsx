...
const App = () => {
  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden">
      {/* Background Effects - Optimized for both mobile and desktop */}
            ...
            >
              ...
              <div className="relative flex flex-col md:flex-row md:items-start md:justify-between">
                ...
                <div className={`flex items-center ${isMobile ? 'justify-end mt-3 space-x-2' : 'space-x-4'}`}>
                  <button className={`${isMobile ? 'p-2' : 'p-3'} text-gray-400 hover:text-red-400 transition-colors duration-300 hover:scale-110`}>
